...
float constantI            = 0.020138f;   // A for low-resistance constant-current source  *as of 25/08/13
...
// This is for the earlier Mega V5 PCB float EEPROM_MAXV = 4.9854f; //this is constant. as of 25/08/13
float EEPROM_SleepV = 0.6117; //this is constant.

float VOLTAGE_SCALE = 68.5289; // Calibration scale factor for voltage input
